...
`;
    ...
    headerEle === null || headerEle === void 0 ? void 0 : headerEle.innerHTML = `
<header>
        <div class="container">
...
`;
    ...
    const bars = document.querySelector("aside .aside-content .header-bars-mobile");
    const heaedr_menu = document.querySelector("aside .aside-content .header-menu-mobile");
    bars.addEventListener("click", () => {
        heaedr_menu.classList.toggle("active");
    });
    // Super Deals
    const activeSections = document.querySelectorAll(".super-deals-products-filter span");
    ...
    // hot-new-arrival
    const hotNewArrivalActive = document.querySelectorAll(".hot-new-arrival-filter span");
    ...
    // Shop
    const shop_products_items_top_filter_dropdownEle = document.querySelectorAll(".shop-products-items-top-filter-dropdown p");
    const shop_products_items_top_filter_wrapper = document.querySelector(".shop-products-items-top-filter-wrapper > p button");
    shop_products_items_top_filter_dropdownEle.forEach((ele) => {
        ele === null || ele === void 0 ? void 0 : ele.addEventListener("click", () => {
            shop_products_items_top_filter_wrapper === null || shop_products_items_top_filter_wrapper === void 0 ? void 0 : shop_products_items_top_filter_wrapper.innerHTML =
                ele.innerText + ` <i class="fas fa-angle-down"></i>`;
        });
    });
    // Cart
    const plueEle = document.querySelector(".cart-page-cartlist-items-item-quantity-plus");
    const minusEle = document.querySelector(".cart-page-cartlist-items-item-quantity-minus");
    const cartQuantityEle = document.querySelector(".cart-page-cartlist-items-item-quantity-num");
    const cartPrice = document.querySelector(".cart-page-cartlist-items-item-quantity-price");
    const cartTotalPrice = document.querySelector(".cart-page-cartlist-items-item-quantity-totalprice");
    cartTotalPrice.innerText = `${+cartPrice.innerText * +cartQuantityEle.innerText}`;
    ...
    deleteCartBtn === null || deleteCartBtn === void 0 ? void 0 : deleteCartBtn.addEventListener("click", () => {
